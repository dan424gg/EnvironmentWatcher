...
public class AlertWorker(context: Context, workerParams: WorkerParameters) :
    ...
    override suspend fun doWork(): Result {
        ...
        // This method will be called periodically based on the repeat interval
        ...
        val response = AlertPing.getAlertData(LatLng(CurrentLocation.latitude, CurrentLocation.longitude))
        if (response != null) {
